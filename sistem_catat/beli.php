...
if (isset($_POST['simpan'])) {
    ...
    if ($supplier != '' && $bahan != '' && $tanggal != '' && $jumlah != '' && $biaya != '') {
        $kueri = "INSERT INTO tb_pembelian (nama_supplier, nama_bahan, tanggal_beli, jumlah_beli, total_bayar) VALUES ('$supplier', '$bahan', '$tanggal', '$jumlah', '$biaya')";
...
<html lang="id">
    <head>
        ...
        <title>Tahu Tempe Dua Putri - Bahan Baku</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Pembelian Bahan Baku</h1>
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="card shadow-sm">
                                    <div class="card-header bg-primary text-white">
                                        <h5 class="mb-0">Catat Pembelian Kedelai</h5>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="">
                                            ...
                                            <div class="form-group">
                                                <label>Jumlah Beli (Kg / Liter / Bungkus)</label>
                                            ...
                                            <button type="submit" name="simpan" class="btn btn-primary btn-block btn-lg">Simpan Pembelian</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
