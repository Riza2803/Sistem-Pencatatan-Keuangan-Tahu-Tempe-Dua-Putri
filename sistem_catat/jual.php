...
if (isset($_POST['simpan'])) {
    ...
    if ($tanggal != '' && $kategori != '' && $produk != '' && $jumlah != '' && $pendapatan != '') {
        $kueri = "INSERT INTO tb_penjualan (nama_produk, kategori_pembeli, tanggal_jual, jumlah_jual, total_pendapatan) VALUES ('$produk', '$kategori', '$tanggal', '$jumlah', '$pendapatan')";
        mysqli_query($conn, $kueri);
        $message = '<div class="alert alert-success">Data penjualan berhasil disimpan.</div>';
    } else {
...
<html lang="id">
    <head>
        ...
        <title>Tahu Tempe Dua Putri - Penjualan</title>
                            ...
                            <div class="col-12">
                                <div class="card shadow-sm">
                                    <div class="card-header bg-info text-white">
                                        <h5 class="mb-0">Catat Transaksi Penjualan</h5>
                                    </div>
                                    <div class="card-body">
                                        <?php echo $message; ?>
                                        <form method="POST" action="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="kategori" class="form-control" required>
                                                    <option value="Pasar">Pasar Induk</option>
                                                    <option value="Pabrik">Pabrik / Perusahaan</option>
                                            ...
                                            <div class="form-group">
                                                <label>Jumlah Produk Terjual (Rinjing / Ancak)</label>
                                            ...
                                            <button type="submit" name="simpan" class="btn btn-info btn-block btn-lg">Simpan Penjualan</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
